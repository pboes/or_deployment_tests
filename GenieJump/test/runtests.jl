...
# !!! Main.UserApp is configured as an alias for Main.GenieJump and you might encounter it in some tests
using Main.GenieJump, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "GenieJump tests" begin
  @includetests ARGS
end
